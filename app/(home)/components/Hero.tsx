      ...
      <div className="absolute inset-0 flex items-center justify-end pr-10">
        ...
        <div className="w-fit justify-center   rounded-xl bg-cover bg-center bg-no-repeat">
          <div className="flex flex-col gap-6 p-6 md:p-12 text-end items-end">
            <motion.h1 initial={{  opacity : 0 }} animate={{ opacity : isVisible ? 1 : 0 }} transition={{ repeatDelay: 2, duration: 1 }} className="dark:text-white  text-4xl sm:text-5xl lg:text-6xl font-black tracking">M IQBAL FATKHUL HIKAM</motion.h1>
            <motion.h2 initial={{  opacity : 0 }} animate={{ opacity : isVisible ? 1 : 0 }} transition={{ repeatDelay: 2, duration: 1 }} className="dark:text-accent-foreground text-lg sm:text-xl max-w-3xl">
