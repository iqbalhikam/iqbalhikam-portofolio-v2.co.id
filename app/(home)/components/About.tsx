...
const About = () => {
  ...
  return (
    <motion.div ref={sectionRef} initial={{ opacity: 0 }} animate={{ opacity: isVisible ? 1 : 0 }} className="flex flex-col items-center justify-center min-h-screen border border-red-500 ">
      <h2 className="text-4xl font-bold pb-10">About Me</h2>
