...
const About = () => {
  ...
  return (
    <div ref={sectionRef} className="flex flex-col items-center justify-center min-h-screen p-5 lg:p-20 ">
      <div className="dark:bg-secondary/20 bg-accent py-20 lg:py-50 rounded-2xl ">
        <motion.h2 initial={{ opacity: 0 }} animate={{ opacity: isVisible ? 1 : 0 }} className="text-2xl lg:text-4xl text-center font-bold pb-10">
          About Me
        </motion.h2>
        <motion.p initial={{ y: -20 }} transition={{ duration: 0.5 }} animate={{ y: isVisible ? 0 : 20 }} className="text-sm lg:text-lg text-center px-5 lg:px-20">
