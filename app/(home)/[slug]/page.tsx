      ...
      <main className="flex-1 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            <section>
              <h1 className="text-4xl md:text-5xl font-black text-secondary-foreground mb-4">{project?.title}</h1>

              <Badge variant={'outline'} className="rounded-full px-5">
                <p className="text-xs text-accent-foreground">{project?.app}</p>
              </Badge>
            </section>
            ...
            <section>
              <h2 className="text-3xl font-bold text-secondary-foreground mb-6">project Details</h2>
            ...
            <div className="flex justify-center pt-8">
              <ButtonBack className="inline-flex items-center justify-center rounded-lg h-12 px-8 bg-primary text-white text-sm font-bold tracking-wide shadow-lg hover:bg-primary/90 transition-all focus:outline-none focus:ring-4 focus:ring-primary/30">
                Back to Portfolio
              </ButtonBack>
            </div>
          </div>
