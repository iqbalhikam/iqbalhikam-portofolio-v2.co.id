        ...
        <div className="max-w-4xl mx-auto">
          <section className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-16">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">M Iqbal Fatkhul Hikam</h1>
              <p className="text-lg text-primary font-medium mt-2">Software Engineer</p>
              <p className="text-base text-gray-500 dark:text-gray-400 mt-1">Based in Bojonegoro, ID</p>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-baseline">
                  <p className="text-base font-medium text-gray-800 dark:text-gray-200">JavaScript / TypeScript</p>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-baseline">
                  <p className="text-base font-medium text-gray-800 dark:text-gray-200">React.js</p>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-baseline">
                  <p className="text-base font-medium text-gray-800 dark:text-gray-200">Node.js (Express)</p>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-baseline">
                  <p className="text-base font-medium text-gray-800 dark:text-gray-200">SQL (PostgreSQL / MySQL)</p>
